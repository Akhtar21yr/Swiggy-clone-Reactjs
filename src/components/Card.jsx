    ...
    return (
        <div className='w-full md:w-[273px] shrink-0 '>
            <div className='group h-[182px] rounded-[15px] overflow-hidden relative '>
                ...
                <div className='image-overlay absolute w-full h-full top-0 flex items-end justify-center p-2 text-[22px] font-bold text-white tracking-tighter'>
                    {props.offer}
                </div>
            </div>
            <div className='mx-3'>
                <div className='mt-1 text-md  md:text-xl font-bold'>
                    {props.title}
                </div>
                <div>
                    <Star /> {props.rating}
